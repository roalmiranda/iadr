                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-9">
                            <div class="banner-caption cpn tc-light text-center">
                                <div class="cpn-head">
                                    <h2 class="title title-xl-2 animated fadeInUp tc-primary" data-animate="fadeInUp" data-delay="1.25" style="visibility: visible; animation-delay: 1.25s;">Quiénes Somos</h2>
                                    <b class="animated fadeInUp" data-animate="fadeInUp" data-delay="1.25">
                                        <p class="tc-default"><a href="/">Inicio</a> > Quiénes Somos</p>
                                    </b>
                                </div>
                            </div>
                        </div>
...
<section class="section" style="padding-top: 50px;">
    <div class="container">
        ...
        <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">Avance Profesional</h2>
        <!-- Block @s -->
        <div class="nk-block">
            <div class="row gutter-vr-30px align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="nk-block-video zoom-animation">
                        <img src="imagesiadr/iadr1.jpg" alt="video">
                    </div>
                </div>
            </div>
        </div>
