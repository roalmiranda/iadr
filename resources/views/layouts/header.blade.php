        ...
        <div class="header-wrap">
            ...
            <div class="header-logo logo animated" data-animate="fadeInDown" data-delay=".65">
                <a href="/" class="logo-link">
                    <img class="logo-dark" src="imagesiadr/logo/LogoIADR1.png" style="height: 70px" srcset="imagesiadr/logo/LogoIADR1.png" alt="logo">
                    <img class="logo-light" src="imagesiadr/logo/LogoIADR1.png" style="height: 70px" srcset="imagesiadr/logo/LogoIADR1.png" alt="logo">
                </a>
            </div>
            <!-- Menu Toogle @s -->
