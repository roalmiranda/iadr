                        ...
                        <form id="form" class="contact-form nk-form-submit">
                            ...
                            <div class="row">
                                <div class="col-sm-12 animated fadeInUp" data-animate="fadeInUp" data-delay="1" style="visibility: visible; animation-delay: 1s;">
                                    <button type="submit" class="btn btn-s2 btn-md btn-grad save-contact">Enviar</button>
                                    <button type="submit" class="btn btn-md btn-info save-load" disabled style="display:none;">Enviando...</button>
                                </div>
                            </div>
                        </form>
                    </div>
